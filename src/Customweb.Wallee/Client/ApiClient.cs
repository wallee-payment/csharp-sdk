...
namespace Customweb.Wallee.Client
{
    ...
    public partial class ApiClient
    {
        ...
        {
            Configuration = CheckArgument.NotNull("configuration", configuration);
            ...
            String contentType)
        {
            ...
            {
                // param.Value.Name, param.Value.Writer, param.Value.FileName, param.Value.ContentType
        ...
        public Dictionary<String, String> AuthenticationHeaders(Method method, string path, Dictionary<String, String> queryParams)
        {
            ...
            headers.Add("x-mac-version", version);
            headers.Add("x-mac-userid", userID);
            headers.Add("x-mac-timestamp", timestamp.ToString());
            headers.Add("x-mac-value", CalculateHmac(signature));
            return headers;
        }
