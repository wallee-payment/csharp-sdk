...
namespace Customweb.Wallee.Model
{
    ...
    public partial class SubscriptionProductComponentGroupUpdate :  IEquatable<SubscriptionProductComponentGroupUpdate>
    {
        ...
        public SubscriptionProductComponentGroupUpdate(long? Id = default(long?), long? LinkedSpaceId = default(long?), long? Name = default(long?), bool? Optional = default(bool?), long? ProductVersion = default(long?), int? SortOrder = default(int?), long? Version = default(long?))
        {
            this.Id = Id;
