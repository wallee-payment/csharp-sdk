...
namespace Customweb.Wallee.Model
{
    ...
    public partial class SubscriptionProductComponentUpdate :  IEquatable<SubscriptionProductComponentUpdate>
    {
        ...
        public SubscriptionProductComponentUpdate(int? ComponentChangeWeight = default(int?), long? ComponentGroup = default(long?), bool? DefaultComponent = default(bool?), long? Description = default(long?), long? Id = default(long?), long? LinkedSpaceId = default(long?), long? Name = default(long?), long? Reference = default(long?), int? SortOrder = default(int?), long? TaxClass = default(long?), long? Version = default(long?))
        {
