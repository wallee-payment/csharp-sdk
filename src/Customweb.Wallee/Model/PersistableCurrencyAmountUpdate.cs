...
{
    /// <summary>
    /// Persistable Currency Amount . Update
    /// </summary>
    [DataContract]
    public partial class PersistableCurrencyAmountUpdate :  IEquatable<PersistableCurrencyAmountUpdate>, IValidatableObject
    {
        ...
        public PersistableCurrencyAmountUpdate(string Currency = default(string), decimal? Amount = default(decimal?))
        {
            this.Amount = Amount;
