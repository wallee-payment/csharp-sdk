...
namespace Customweb.Wallee.Model
{
    ...
    public partial class ProductSetupFeeUpdate :  IEquatable<ProductSetupFeeUpdate>
    {
        ...
        public ProductSetupFeeUpdate(long? Component = default(long?), long? Description = default(long?), long? Id = default(long?), long? LinkedSpaceId = default(long?), long? Name = default(long?), List<PersistableCurrencyAmountUpdate> OnDowngradeCreditedAmount = default(List<PersistableCurrencyAmountUpdate>), List<PersistableCurrencyAmountUpdate> OnUpgradeCreditedAmount = default(List<PersistableCurrencyAmountUpdate>), List<PersistableCurrencyAmountUpdate> SetupFee = default(List<PersistableCurrencyAmountUpdate>), ProductFeeType Type = default(ProductFeeType), long? Version = default(long?))
        {
