...
namespace Customweb.Wallee.Model
{
    ...
    public partial class ConditionType :  IEquatable<ConditionType>
    {
        ...
        public ConditionType(Dictionary<string, string> Description = default(Dictionary<string, string>), long? Id = default(long?), Dictionary<string, string> Name = default(Dictionary<string, string>))
        {
