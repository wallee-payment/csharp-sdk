...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenUpdate :  IEquatable<TokenUpdate>
    {
        /// <summary>
        ...
        public TokenUpdate(DateTime? CreatedOn = default(DateTime?), string CustomerEmailAddress = default(string), string CustomerId = default(string), bool? EnabledForOneClickPayment = default(bool?), string ExternalId = default(string), long? Id = default(long?), string Language = default(string), long? LinkedSpaceId = default(long?), DateTime? PlannedPurgeDate = default(DateTime?), CreationEntityState State = default(CreationEntityState), string TokenReference = default(string), long? Version = default(long?))
        {
