...
{
    /// <summary>
    /// Abstract Payment Link
    /// </summary>
    [DataContract]
    public partial class AbstractPaymentLinkUpdate :  IEquatable<AbstractPaymentLinkUpdate>, IValidatableObject
    {
        ...
        public AbstractPaymentLinkUpdate(string Name = default(string), DateTime? AvailableUntil = default(DateTime?), bool? ShippingAddressRequired = default(bool?), int? MaximalNumberOfTransactions = default(int?), DateTime? AvailableFrom = default(DateTime?), string Currency = default(string), List<LineItemCreate> LineItems = default(List<LineItemCreate>), List<PaymentMethodConfiguration> AllowedPaymentMethodConfigurations = default(List<PaymentMethodConfiguration>), long? AppliedSpaceView = default(long?), bool? BillingAddressRequired = default(bool?), string Language = default(string))
        {
        ...
        {
            return this.Equals(obj as AbstractPaymentLinkUpdate);
        }

        /// <summary>
        /// Returns true if AbstractPaymentLinkUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of AbstractPaymentLinkUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractPaymentLinkUpdate other)
        {
            if (other == null)
            {
                return false;
