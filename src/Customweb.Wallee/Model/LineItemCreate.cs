...
namespace Customweb.Wallee.Model
{
    ...
    public partial class LineItemCreate :  IEquatable<LineItemCreate>
    {
        ...
        public LineItemCreate(decimal? AggregatedTaxRate = default(decimal?), decimal? AmountExcludingTax = default(decimal?), decimal? AmountIncludingTax = default(decimal?), string Name = default(string), decimal? Quantity = default(decimal?), bool? ShippingRequired = default(bool?), string Sku = default(string), decimal? TaxAmount = default(decimal?), decimal? TaxAmountPerUnit = default(decimal?), List<TaxCreate> Taxes = default(List<TaxCreate>), LineItemType Type = default(LineItemType), string UniqueId = default(string), decimal? UnitPriceExcludingTax = default(decimal?), decimal? UnitPriceIncludingTax = default(decimal?))
        {
