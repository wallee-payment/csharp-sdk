...
namespace Customweb.Wallee.Model
{
    ...
    public partial class StaticValue :  IEquatable<StaticValue>
    {
        ...
        public StaticValue(Dictionary<string, string> Description = default(Dictionary<string, string>), List<long?> Features = default(List<long?>), long? Id = default(long?), Dictionary<string, string> Name = default(Dictionary<string, string>))
        {
        ...
        {
            return this.Equals(obj as StaticValue);
        }

        /// <summary>
        /// Returns true if StaticValue instances are equal
        /// </summary>
        /// <param name="other">Instance of StaticValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaticValue other)
        {
            if (other == null)
            {
                return false;
