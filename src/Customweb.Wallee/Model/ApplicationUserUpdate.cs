...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicationUserUpdate : AbstractApplicationUserUpdate,  IEquatable<ApplicationUserUpdate>, IValidatableObject
    {
        ...
        {
            return this.Equals(obj as ApplicationUserUpdate);
        }

        /// <summary>
        /// Returns true if ApplicationUserUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of ApplicationUserUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUserUpdate other)
        {
            if (other == null)
            {
                return false;
