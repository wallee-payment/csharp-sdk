...
namespace Customweb.Wallee.Model
{
    ...
    public partial class Condition :  IEquatable<Condition>
    {
        ...
        /// </summary>
        /// <param name="ConditionType">The selected condition type defines how the configuration is applied to the transactions.</param>
        ...
        /// <param name="Name">The condition name is used internally to identify the condition. For example the name is used within search fields and hence it should be distinct and descriptive.</param>
        ...
        public Condition(long? ConditionType = default(long?), long? Id = default(long?), long? LinkedSpaceId = default(long?), string Name = default(string), DateTime? PlannedPurgeDate = default(DateTime?), CreationEntityState State = default(CreationEntityState), int? Version = default(int?))
        {
