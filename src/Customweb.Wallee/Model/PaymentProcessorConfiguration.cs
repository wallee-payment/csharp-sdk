...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentProcessorConfiguration :  IEquatable<PaymentProcessorConfiguration>, IValidatableObject
    {
        ...
        {
            return this.Equals(obj as PaymentProcessorConfiguration);
        }

        /// <summary>
        /// Returns true if PaymentProcessorConfiguration instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentProcessorConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentProcessorConfiguration other)
        {
            if (other == null)
            {
                return false;
