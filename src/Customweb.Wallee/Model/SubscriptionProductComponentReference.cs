...
namespace Customweb.Wallee.Model
{
    ...
    public partial class SubscriptionProductComponentReference :  IEquatable<SubscriptionProductComponentReference>
    {
        ...
        /// <param name="Name">The component reference name is used internally to identify the reference. For example the name is used within search fields and hence it should be distinct and descriptive.</param>
        ...
        public SubscriptionProductComponentReference(long? Id = default(long?), long? LinkedSpaceId = default(long?), string Name = default(string), DateTime? PlannedPurgeDate = default(DateTime?), long? SpaceId = default(long?), SubscriptionProductComponentReferenceState State = default(SubscriptionProductComponentReferenceState), int? Version = default(int?))
        {
            this.Id = Id;
        ...
        {
            return this.Equals(obj as SubscriptionProductComponentReference);
        }

        /// <summary>
        /// Returns true if SubscriptionProductComponentReference instances are equal
        /// </summary>
        /// <param name="other">Instance of SubscriptionProductComponentReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionProductComponentReference other)
        {
            if (other == null)
            {
                return false;
