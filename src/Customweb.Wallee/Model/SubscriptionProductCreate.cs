...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionProductCreate :  IEquatable<SubscriptionProductCreate>
    {
        /// <summary>
