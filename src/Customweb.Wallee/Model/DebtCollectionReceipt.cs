...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebtCollectionReceipt :  IEquatable<DebtCollectionReceipt>, IValidatableObject
    {
        ...
        {
            return this.Equals(obj as DebtCollectionReceipt);
        }

        /// <summary>
        /// Returns true if DebtCollectionReceipt instances are equal
        /// </summary>
        /// <param name="other">Instance of DebtCollectionReceipt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtCollectionReceipt other)
        {
            if (other == null)
            {
                return false;
