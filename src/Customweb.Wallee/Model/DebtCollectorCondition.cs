...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebtCollectorCondition :  IEquatable<DebtCollectorCondition>, IValidatableObject
    {
        ...
        {
            return this.Equals(obj as DebtCollectorCondition);
        }

        /// <summary>
        /// Returns true if DebtCollectorCondition instances are equal
        /// </summary>
        /// <param name="other">Instance of DebtCollectorCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtCollectorCondition other)
        {
            if (other == null)
            {
                return false;
