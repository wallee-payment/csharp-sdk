...
namespace Customweb.Wallee.Model
{
    ...
    public partial class HumanUser :  IEquatable<HumanUser>
    {
        ...
        public HumanUser(long? Id = default(long?), DateTime? PlannedPurgeDate = default(DateTime?), Scope Scope = default(Scope), CreationEntityState State = default(CreationEntityState), UserType UserType = default(UserType), int? Version = default(int?), string EmailAddress = default(string), bool? EmailAddressVerified = default(bool?), string Firstname = default(string), string Language = default(string), string Lastname = default(string), Account PrimaryAccount = default(Account), string TimeZone = default(string))
        {
            this.Id = Id;
