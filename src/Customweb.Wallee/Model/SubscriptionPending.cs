...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionPending :  IEquatable<SubscriptionPending>
    {
        /// <summary>
        ...
        public SubscriptionPending(DateTime? CreatedOn = default(DateTime?), string Description = default(string), long? Id = default(long?), DateTime? InitializedOn = default(DateTime?), string Language = default(string), long? LinkedSpaceId = default(long?), DateTime? PlannedPurgeDate = default(DateTime?), DateTime? PlannedTerminationDate = default(DateTime?), string Reference = default(string), SubscriptionState State = default(SubscriptionState), long? Subscriber = default(long?), DateTime? TerminatedOn = default(DateTime?), DateTime? TerminatingOn = default(DateTime?), long? Token = default(long?), long? Version = default(long?))
        {
