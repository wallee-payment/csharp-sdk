...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionCreate :  IEquatable<TransactionCreate>
    {
        /// <summary>
