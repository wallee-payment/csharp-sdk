...
namespace Customweb.Wallee.Model
{
    ...
    public partial class Subscription :  IEquatable<Subscription>
    {
        ...
        public Subscription(DateTime? CreatedOn = default(DateTime?), string Description = default(string), long? Id = default(long?), DateTime? InitializedOn = default(DateTime?), string Language = default(string), long? LinkedSpaceId = default(long?), DateTime? PlannedPurgeDate = default(DateTime?), DateTime? PlannedTerminationDate = default(DateTime?), string Reference = default(string), SubscriptionState State = default(SubscriptionState), Subscriber Subscriber = default(Subscriber), DateTime? TerminatedOn = default(DateTime?), DateTime? TerminatingOn = default(DateTime?), Token Token = default(Token), int? Version = default(int?))
        {
