...
namespace Customweb.Wallee.Model
{
    ...
    public partial class WebhookUrl :  IEquatable<WebhookUrl>
    {
        ...
        public WebhookUrl(long? Id = default(long?), long? LinkedSpaceId = default(long?), string Name = default(string), DateTime? PlannedPurgeDate = default(DateTime?), CreationEntityState State = default(CreationEntityState), string Url = default(string), int? Version = default(int?))
        {
            this.Id = Id;
        ...
        {
            return this.Equals(obj as WebhookUrl);
        }

        /// <summary>
        /// Returns true if WebhookUrl instances are equal
        /// </summary>
        /// <param name="other">Instance of WebhookUrl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookUrl other)
        {
            if (other == null)
            {
                return false;
