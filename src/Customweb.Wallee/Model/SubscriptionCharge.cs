...
namespace Customweb.Wallee.Model
{
    ...
    public partial class SubscriptionCharge :  IEquatable<SubscriptionCharge>
    {
        ...
        public SubscriptionCharge(DateTime? CreatedOn = default(DateTime?), long? DiscardedBy = default(long?), DateTime? DiscardedOn = default(DateTime?), string ExternalId = default(string), DateTime? FailedOn = default(DateTime?), string FailedUrl = default(string), long? Id = default(long?), List<SubscriptionLedgerEntry> LedgerEntries = default(List<SubscriptionLedgerEntry>), long? LinkedSpaceId = default(long?), DateTime? PlannedExecutionDate = default(DateTime?), DateTime? PlannedPurgeDate = default(DateTime?), SubscriptionChargeProcessingType ProcessingType = default(SubscriptionChargeProcessingType), string Reference = default(string), SubscriptionChargeState State = default(SubscriptionChargeState), Subscription Subscription = default(Subscription), DateTime? SucceedOn = default(DateTime?), string SuccessUrl = default(string), Transaction Transaction = default(Transaction), SubscriptionChargeType Type = default(SubscriptionChargeType), int? Version = default(int?))
        {
