...
namespace Customweb.Wallee.Model
{
    ...
    public partial class ProductPeriodFee :  IEquatable<ProductPeriodFee>
    {
        ...
        public ProductPeriodFee(SubscriptionProductComponent Component = default(SubscriptionProductComponent), DatabaseTranslatedString Description = default(DatabaseTranslatedString), long? Id = default(long?), long? LinkedSpaceId = default(long?), DatabaseTranslatedString Name = default(DatabaseTranslatedString), int? NumberOfFreeTrialPeriods = default(int?), List<PersistableCurrencyAmount> PeriodFee = default(List<PersistableCurrencyAmount>), ProductFeeType Type = default(ProductFeeType), int? Version = default(int?))
        {
        ...
        public List<PersistableCurrencyAmount> PeriodFee { get; set; }
