...
namespace Customweb.Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpaceReference :  IEquatable<SpaceReference>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpaceReference" /> class.
        /// </summary>
        ...
        public SpaceReference(DateTime? CreatedOn = default(DateTime?), long? Id = default(long?), long? LinkedSpaceId = default(long?), DateTime? PlannedPurgeDate = default(DateTime?), long? SpaceId = default(long?), SpaceReferenceState State = default(SpaceReferenceState), int? Version = default(int?))
        {
        ...
        public SpaceReferenceState State { get; set; }
        ...
        {
            return this.Equals(obj as SpaceReference);
        }

        /// <summary>
        /// Returns true if SpaceReference instances are equal
        /// </summary>
        /// <param name="other">Instance of SpaceReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpaceReference other)
        {
            if (other == null)
            {
                return false;
