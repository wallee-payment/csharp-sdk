...
namespace Customweb.Wallee.Service
{
    ...
    public interface IChargeFlowService : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Transaction> ApplyFlowAsync (long? spaceId, long? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<Transaction>> ApplyFlowAsyncWithHttpInfo (long? spaceId, long? id);
        ...
        /// <param name="spaceId"></param>
        /// <param name="id">The id of the charge flow which should be returned.</param>
        /// <returns>Task of ChargeFlow</returns>
        System.Threading.Tasks.Task<ChargeFlow> ReadAsync (long? spaceId, long? id);
        ...
        /// <param name="spaceId"></param>
        /// <param name="id">The id of the charge flow which should be returned.</param>
        /// <returns>Task of ApiResponse (ChargeFlow)</returns>
        System.Threading.Tasks.Task<ApiResponse<ChargeFlow>> ReadAsyncWithHttpInfo (long? spaceId, long? id);
        ...
        /// <param name="spaceId"></param>
        /// <param name="query">The query restricts the charge flows which are returned by the search.</param>
        /// <returns>Task of List&lt;ChargeFlow&gt;</returns>
        System.Threading.Tasks.Task<List<ChargeFlow>> SearchAsync (long? spaceId, EntityQuery query);
        ...
        /// <param name="spaceId"></param>
        /// <param name="query">The query restricts the charge flows which are returned by the search.</param>
        /// <returns>Task of ApiResponse (List&lt;ChargeFlow&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ChargeFlow>>> SearchAsyncWithHttpInfo (long? spaceId, EntityQuery query);
        ...
        System.Threading.Tasks.Task UpdateRecipientAsync (long? spaceId, long? transactionId, long? type, string recipient);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateRecipientAsyncWithHttpInfo (long? spaceId, long? transactionId, long? type, string recipient);
    ...
    public partial class ChargeFlowService : IChargeFlowService
    {
        ...
        /// <returns></returns>
        public ChargeFlowService(Configuration configuration = null)
        {
        ...
        /// <param name="id">The transaction id of the transaction which should be process asynchronously.</param>
        /// <returns>Task of Transaction</returns>
        public async System.Threading.Tasks.Task<Transaction> ApplyFlowAsync (long? spaceId, long? id)
        {
             ApiResponse<Transaction> localVarResponse = await ApplyFlowAsyncWithHttpInfo(spaceId, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The transaction id of the transaction which should be process asynchronously.</param>
        /// <returns>Task of ApiResponse (Transaction)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Transaction>> ApplyFlowAsyncWithHttpInfo (long? spaceId, long? id)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        public ApiResponse< ChargeFlow > ReadWithHttpInfo (long? spaceId, long? id)
        {
            ...
            return new ApiResponse<ChargeFlow>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ChargeFlow) ApiClient.Deserialize(localVarResponse, typeof(ChargeFlow)));
        }
        ...
        /// <param name="id">The id of the charge flow which should be returned.</param>
        /// <returns>Task of ChargeFlow</returns>
        public async System.Threading.Tasks.Task<ChargeFlow> ReadAsync (long? spaceId, long? id)
        {
             ApiResponse<ChargeFlow> localVarResponse = await ReadAsyncWithHttpInfo(spaceId, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the charge flow which should be returned.</param>
        /// <returns>Task of ApiResponse (ChargeFlow)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ChargeFlow>> ReadAsyncWithHttpInfo (long? spaceId, long? id)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        public ApiResponse< List<ChargeFlow> > SearchWithHttpInfo (long? spaceId, EntityQuery query)
        {
            ...
            return new ApiResponse<List<ChargeFlow>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ChargeFlow>) ApiClient.Deserialize(localVarResponse, typeof(List<ChargeFlow>)));
        }
        ...
        /// <param name="query">The query restricts the charge flows which are returned by the search.</param>
        /// <returns>Task of List&lt;ChargeFlow&gt;</returns>
        public async System.Threading.Tasks.Task<List<ChargeFlow>> SearchAsync (long? spaceId, EntityQuery query)
        {
             ApiResponse<List<ChargeFlow>> localVarResponse = await SearchAsyncWithHttpInfo(spaceId, query);
             return localVarResponse.Data;
        }
        ...
        /// <param name="query">The query restricts the charge flows which are returned by the search.</param>
        /// <returns>Task of ApiResponse (List&lt;ChargeFlow&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ChargeFlow>>> SearchAsyncWithHttpInfo (long? spaceId, EntityQuery query)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        public ApiResponse<Object> UpdateRecipientWithHttpInfo (long? spaceId, long? transactionId, long? type, string recipient)
        {
            ...
            if (recipient != null) localVarQueryParams.Add("recipient", ApiClient.ParameterToString(recipient)); // query parameter
        ...
        /// <param name="recipient">The recipient address that should be used to send the payment URL.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateRecipientAsync (long? spaceId, long? transactionId, long? type, string recipient)
        {
             await UpdateRecipientAsyncWithHttpInfo(spaceId, transactionId, type, recipient);
        }
        ...
        /// <param name="recipient">The recipient address that should be used to send the payment URL.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateRecipientAsyncWithHttpInfo (long? spaceId, long? transactionId, long? type, string recipient)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
