...
namespace Customweb.Wallee.Service
{
    ...
    public interface ILabelDescriptionService : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;LabelDescriptor&gt;</returns>
        System.Threading.Tasks.Task<List<LabelDescriptor>> AllAsync ();
        ...
        /// </remarks>
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;LabelDescriptor&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<LabelDescriptor>>> AllAsyncWithHttpInfo ();
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The id of the label descriptor which should be returned.</param>
        /// <returns>Task of LabelDescriptor</returns>
        System.Threading.Tasks.Task<LabelDescriptor> ReadAsync (long? id);
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The id of the label descriptor which should be returned.</param>
        /// <returns>Task of ApiResponse (LabelDescriptor)</returns>
        System.Threading.Tasks.Task<ApiResponse<LabelDescriptor>> ReadAsyncWithHttpInfo (long? id);
    ...
    public partial class LabelDescriptionService : ILabelDescriptionService
    {
        ...
        /// <returns></returns>
        public LabelDescriptionService(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<LabelDescriptor> > AllWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<LabelDescriptor>>(localVarStatusCode,
                ...
                (List<LabelDescriptor>) ApiClient.Deserialize(localVarResponse, typeof(List<LabelDescriptor>)));
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;LabelDescriptor&gt;</returns>
        public async System.Threading.Tasks.Task<List<LabelDescriptor>> AllAsync ()
        {
             ApiResponse<List<LabelDescriptor>> localVarResponse = await AllAsyncWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;LabelDescriptor&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<LabelDescriptor>>> AllAsyncWithHttpInfo ()
        {
        ...
        public ApiResponse< LabelDescriptor > ReadWithHttpInfo (long? id)
        {
            ...
            return new ApiResponse<LabelDescriptor>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (LabelDescriptor) ApiClient.Deserialize(localVarResponse, typeof(LabelDescriptor)));
        }
        ...
        /// <param name="id">The id of the label descriptor which should be returned.</param>
        /// <returns>Task of LabelDescriptor</returns>
        public async System.Threading.Tasks.Task<LabelDescriptor> ReadAsync (long? id)
        {
             ApiResponse<LabelDescriptor> localVarResponse = await ReadAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the label descriptor which should be returned.</param>
        /// <returns>Task of ApiResponse (LabelDescriptor)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LabelDescriptor>> ReadAsyncWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
