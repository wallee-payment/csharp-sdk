...
namespace Customweb.Wallee.Service
{
    ...
    public interface ISubscriberService : IApiAccessor
    {
        ...
        /// <param name="spaceId"></param>
        /// <param name="entity">The customer object with the properties which should be created.</param>
        /// <returns>Task of SubscriberCreate</returns>
        System.Threading.Tasks.Task<SubscriberCreate> CreateAsync (long? spaceId, SubscriberCreate entity);
        ...
        /// <param name="spaceId"></param>
        /// <param name="entity">The customer object with the properties which should be created.</param>
        /// <returns>Task of ApiResponse (SubscriberCreate)</returns>
        System.Threading.Tasks.Task<ApiResponse<SubscriberCreate>> CreateAsyncWithHttpInfo (long? spaceId, SubscriberCreate entity);
        ...
        System.Threading.Tasks.Task<Subscriber> ReadAsync (long? spaceId, long? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<Subscriber>> ReadAsyncWithHttpInfo (long? spaceId, long? id);
        ...
        System.Threading.Tasks.Task<List<Subscriber>> SearchAsync (long? spaceId, EntityQuery query);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Subscriber>>> SearchAsyncWithHttpInfo (long? spaceId, EntityQuery query);
        ...
        /// <param name="entity">The customer with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of Subscriber</returns>
        System.Threading.Tasks.Task<Subscriber> UpdateAsync (long? spaceId, SubscriberUpdate entity);
        ...
        /// <param name="entity">The customer with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of ApiResponse (Subscriber)</returns>
        System.Threading.Tasks.Task<ApiResponse<Subscriber>> UpdateAsyncWithHttpInfo (long? spaceId, SubscriberUpdate entity);
    ...
    public partial class SubscriberService : ISubscriberService
    {
        ...
        /// <returns></returns>
        public SubscriberService(Configuration configuration = null)
        {
        ...
        public ApiResponse< SubscriberCreate > CreateWithHttpInfo (long? spaceId, SubscriberCreate entity)
        {
            ...
            return new ApiResponse<SubscriberCreate>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (SubscriberCreate) ApiClient.Deserialize(localVarResponse, typeof(SubscriberCreate)));
        }
        ...
        /// <param name="entity">The customer object with the properties which should be created.</param>
        /// <returns>Task of SubscriberCreate</returns>
        public async System.Threading.Tasks.Task<SubscriberCreate> CreateAsync (long? spaceId, SubscriberCreate entity)
        {
             ApiResponse<SubscriberCreate> localVarResponse = await CreateAsyncWithHttpInfo(spaceId, entity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="entity">The customer object with the properties which should be created.</param>
        /// <returns>Task of ApiResponse (SubscriberCreate)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SubscriberCreate>> CreateAsyncWithHttpInfo (long? spaceId, SubscriberCreate entity)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        public ApiResponse< Subscriber > ReadWithHttpInfo (long? spaceId, long? id)
        {
            ...
            return new ApiResponse<Subscriber>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (Subscriber) ApiClient.Deserialize(localVarResponse, typeof(Subscriber)));
        }
        ...
        /// <param name="id">The id of the customer which should be returned.</param>
        /// <returns>Task of Subscriber</returns>
        public async System.Threading.Tasks.Task<Subscriber> ReadAsync (long? spaceId, long? id)
        {
             ApiResponse<Subscriber> localVarResponse = await ReadAsyncWithHttpInfo(spaceId, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the customer which should be returned.</param>
        /// <returns>Task of ApiResponse (Subscriber)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Subscriber>> ReadAsyncWithHttpInfo (long? spaceId, long? id)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        public ApiResponse< List<Subscriber> > SearchWithHttpInfo (long? spaceId, EntityQuery query)
        {
            ...
            return new ApiResponse<List<Subscriber>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<Subscriber>) ApiClient.Deserialize(localVarResponse, typeof(List<Subscriber>)));
        }
        ...
        /// <param name="query">The query restricts the customer which are returned by the search.</param>
        /// <returns>Task of List&lt;Subscriber&gt;</returns>
        public async System.Threading.Tasks.Task<List<Subscriber>> SearchAsync (long? spaceId, EntityQuery query)
        {
             ApiResponse<List<Subscriber>> localVarResponse = await SearchAsyncWithHttpInfo(spaceId, query);
             return localVarResponse.Data;
        }
        ...
        /// <param name="query">The query restricts the customer which are returned by the search.</param>
        /// <returns>Task of ApiResponse (List&lt;Subscriber&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Subscriber>>> SearchAsyncWithHttpInfo (long? spaceId, EntityQuery query)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        /// <param name="entity">The customer with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of Subscriber</returns>
        public async System.Threading.Tasks.Task<Subscriber> UpdateAsync (long? spaceId, SubscriberUpdate entity)
        {
             ApiResponse<Subscriber> localVarResponse = await UpdateAsyncWithHttpInfo(spaceId, entity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="entity">The customer with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of ApiResponse (Subscriber)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Subscriber>> UpdateAsyncWithHttpInfo (long? spaceId, SubscriberUpdate entity)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
