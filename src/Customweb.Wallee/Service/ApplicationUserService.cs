...
namespace Customweb.Wallee.Service
{
    ...
    public interface IApplicationUserService : IApiAccessor
    {
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="entity">The user object with the properties which should be created.</param>
        /// <returns>Task of ApplicationUserCreateWithMacKey</returns>
        System.Threading.Tasks.Task<ApplicationUserCreateWithMacKey> CreateAsync (ApplicationUserCreate entity);
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="entity">The user object with the properties which should be created.</param>
        /// <returns>Task of ApiResponse (ApplicationUserCreateWithMacKey)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApplicationUserCreateWithMacKey>> CreateAsyncWithHttpInfo (ApplicationUserCreate entity);
        ...
        System.Threading.Tasks.Task<ApplicationUser> ReadAsync (long? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<ApplicationUser>> ReadAsyncWithHttpInfo (long? id);
        ...
        System.Threading.Tasks.Task<List<ApplicationUser>> SearchAsync (EntityQuery query);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<ApplicationUser>>> SearchAsyncWithHttpInfo (EntityQuery query);
        ...
        /// <param name="entity">The application user entity with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of ApplicationUser</returns>
        System.Threading.Tasks.Task<ApplicationUser> UpdateAsync (ApplicationUserUpdate entity);
        ...
        /// <param name="entity">The application user entity with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of ApiResponse (ApplicationUser)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApplicationUser>> UpdateAsyncWithHttpInfo (ApplicationUserUpdate entity);
    ...
    public partial class ApplicationUserService : IApplicationUserService
    {
        ...
        /// <returns></returns>
        public ApplicationUserService(Configuration configuration = null)
        {
        ...
        public ApiResponse< ApplicationUserCreateWithMacKey > CreateWithHttpInfo (ApplicationUserCreate entity)
        {
            ...
            return new ApiResponse<ApplicationUserCreateWithMacKey>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ApplicationUserCreateWithMacKey) ApiClient.Deserialize(localVarResponse, typeof(ApplicationUserCreateWithMacKey)));
        }
        ...
        /// <param name="entity">The user object with the properties which should be created.</param>
        /// <returns>Task of ApplicationUserCreateWithMacKey</returns>
        public async System.Threading.Tasks.Task<ApplicationUserCreateWithMacKey> CreateAsync (ApplicationUserCreate entity)
        {
             ApiResponse<ApplicationUserCreateWithMacKey> localVarResponse = await CreateAsyncWithHttpInfo(entity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="entity">The user object with the properties which should be created.</param>
        /// <returns>Task of ApiResponse (ApplicationUserCreateWithMacKey)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApplicationUserCreateWithMacKey>> CreateAsyncWithHttpInfo (ApplicationUserCreate entity)
        {
            // verify the required parameter 'entity' is set
            if (entity == null)
            {
        ...
        public ApiResponse< ApplicationUser > ReadWithHttpInfo (long? id)
        {
            ...
            return new ApiResponse<ApplicationUser>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ApplicationUser) ApiClient.Deserialize(localVarResponse, typeof(ApplicationUser)));
        }
        ...
        /// <param name="id">The id of the application user which should be returned.</param>
        /// <returns>Task of ApplicationUser</returns>
        public async System.Threading.Tasks.Task<ApplicationUser> ReadAsync (long? id)
        {
             ApiResponse<ApplicationUser> localVarResponse = await ReadAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the application user which should be returned.</param>
        /// <returns>Task of ApiResponse (ApplicationUser)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApplicationUser>> ReadAsyncWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        public ApiResponse< List<ApplicationUser> > SearchWithHttpInfo (EntityQuery query)
        {
            ...
            return new ApiResponse<List<ApplicationUser>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<ApplicationUser>) ApiClient.Deserialize(localVarResponse, typeof(List<ApplicationUser>)));
        }
        ...
        /// <param name="query">The query restricts the application users which are returned by the search.</param>
        /// <returns>Task of List&lt;ApplicationUser&gt;</returns>
        public async System.Threading.Tasks.Task<List<ApplicationUser>> SearchAsync (EntityQuery query)
        {
             ApiResponse<List<ApplicationUser>> localVarResponse = await SearchAsyncWithHttpInfo(query);
             return localVarResponse.Data;
        }
        ...
        /// <param name="query">The query restricts the application users which are returned by the search.</param>
        /// <returns>Task of ApiResponse (List&lt;ApplicationUser&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ApplicationUser>>> SearchAsyncWithHttpInfo (EntityQuery query)
        {
            // verify the required parameter 'query' is set
            if (query == null)
            {
        ...
        /// <param name="entity">The application user entity with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of ApplicationUser</returns>
        public async System.Threading.Tasks.Task<ApplicationUser> UpdateAsync (ApplicationUserUpdate entity)
        {
             ApiResponse<ApplicationUser> localVarResponse = await UpdateAsyncWithHttpInfo(entity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="entity">The application user entity with all the properties which should be updated. The id and the version are required properties.</param>
        /// <returns>Task of ApiResponse (ApplicationUser)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApplicationUser>> UpdateAsyncWithHttpInfo (ApplicationUserUpdate entity)
        {
            // verify the required parameter 'entity' is set
            if (entity == null)
            {
