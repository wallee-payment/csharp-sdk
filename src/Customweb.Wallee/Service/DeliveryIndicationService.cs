...
namespace Customweb.Wallee.Service
{
    ...
    public interface IDeliveryIndicationService : IApiAccessor
    {
        ...
        /// <param name="spaceId"></param>
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as not suitable.</param>
        /// <returns>Task of DeliveryIndication</returns>
        System.Threading.Tasks.Task<DeliveryIndication> MarkAsNotSuitableAsync (long? spaceId, long? deliveryIndicationId);
        ...
        /// <param name="spaceId"></param>
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as not suitable.</param>
        /// <returns>Task of ApiResponse (DeliveryIndication)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeliveryIndication>> MarkAsNotSuitableAsyncWithHttpInfo (long? spaceId, long? deliveryIndicationId);
        ...
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as suitable.</param>
        /// <returns>Task of DeliveryIndication</returns>
        System.Threading.Tasks.Task<DeliveryIndication> MarkAsSuitableAsync (long? spaceId, long? deliveryIndicationId);
        ...
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as suitable.</param>
        /// <returns>Task of ApiResponse (DeliveryIndication)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeliveryIndication>> MarkAsSuitableAsyncWithHttpInfo (long? spaceId, long? deliveryIndicationId);
        ...
        /// <param name="id">The id of the delivery indication which should be returned.</param>
        /// <returns>Task of DeliveryIndication</returns>
        System.Threading.Tasks.Task<DeliveryIndication> ReadAsync (long? spaceId, long? id);
        ...
        /// <param name="id">The id of the delivery indication which should be returned.</param>
        /// <returns>Task of ApiResponse (DeliveryIndication)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeliveryIndication>> ReadAsyncWithHttpInfo (long? spaceId, long? id);
        ...
        /// <param name="spaceId"></param>
        /// <param name="query">The query restricts the delivery indications which are returned by the search.</param>
        /// <returns>Task of List&lt;DeliveryIndication&gt;</returns>
        System.Threading.Tasks.Task<List<DeliveryIndication>> SearchAsync (long? spaceId, EntityQuery query);
        ...
        /// <param name="spaceId"></param>
        /// <param name="query">The query restricts the delivery indications which are returned by the search.</param>
        /// <returns>Task of ApiResponse (List&lt;DeliveryIndication&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<DeliveryIndication>>> SearchAsyncWithHttpInfo (long? spaceId, EntityQuery query);
    ...
    public partial class DeliveryIndicationService : IDeliveryIndicationService
    {
        ...
        /// <returns></returns>
        public DeliveryIndicationService(Configuration configuration = null)
        {
        ...
        public ApiResponse< DeliveryIndication > MarkAsNotSuitableWithHttpInfo (long? spaceId, long? deliveryIndicationId)
        {
            ...
            {
                localVarPostBody = ApiClient.Serialize(deliveryIndicationId); // http body (model) parameter
            }
            else
            {
            ...
            return new ApiResponse<DeliveryIndication>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (DeliveryIndication) ApiClient.Deserialize(localVarResponse, typeof(DeliveryIndication)));
        }
        ...
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as not suitable.</param>
        /// <returns>Task of DeliveryIndication</returns>
        public async System.Threading.Tasks.Task<DeliveryIndication> MarkAsNotSuitableAsync (long? spaceId, long? deliveryIndicationId)
        {
             ApiResponse<DeliveryIndication> localVarResponse = await MarkAsNotSuitableAsyncWithHttpInfo(spaceId, deliveryIndicationId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as not suitable.</param>
        /// <returns>Task of ApiResponse (DeliveryIndication)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeliveryIndication>> MarkAsNotSuitableAsyncWithHttpInfo (long? spaceId, long? deliveryIndicationId)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as suitable.</param>
        /// <returns>Task of DeliveryIndication</returns>
        public async System.Threading.Tasks.Task<DeliveryIndication> MarkAsSuitableAsync (long? spaceId, long? deliveryIndicationId)
        {
             ApiResponse<DeliveryIndication> localVarResponse = await MarkAsSuitableAsyncWithHttpInfo(spaceId, deliveryIndicationId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="deliveryIndicationId">The delivery indication id which should be marked as suitable.</param>
        /// <returns>Task of ApiResponse (DeliveryIndication)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeliveryIndication>> MarkAsSuitableAsyncWithHttpInfo (long? spaceId, long? deliveryIndicationId)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        /// <param name="id">The id of the delivery indication which should be returned.</param>
        /// <returns>Task of DeliveryIndication</returns>
        public async System.Threading.Tasks.Task<DeliveryIndication> ReadAsync (long? spaceId, long? id)
        {
             ApiResponse<DeliveryIndication> localVarResponse = await ReadAsyncWithHttpInfo(spaceId, id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the delivery indication which should be returned.</param>
        /// <returns>Task of ApiResponse (DeliveryIndication)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeliveryIndication>> ReadAsyncWithHttpInfo (long? spaceId, long? id)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
        ...
        public ApiResponse< List<DeliveryIndication> > SearchWithHttpInfo (long? spaceId, EntityQuery query)
        {
            ...
            return new ApiResponse<List<DeliveryIndication>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<DeliveryIndication>) ApiClient.Deserialize(localVarResponse, typeof(List<DeliveryIndication>)));
        }
        ...
        /// <param name="query">The query restricts the delivery indications which are returned by the search.</param>
        /// <returns>Task of List&lt;DeliveryIndication&gt;</returns>
        public async System.Threading.Tasks.Task<List<DeliveryIndication>> SearchAsync (long? spaceId, EntityQuery query)
        {
             ApiResponse<List<DeliveryIndication>> localVarResponse = await SearchAsyncWithHttpInfo(spaceId, query);
             return localVarResponse.Data;
        }
        ...
        /// <param name="query">The query restricts the delivery indications which are returned by the search.</param>
        /// <returns>Task of ApiResponse (List&lt;DeliveryIndication&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<DeliveryIndication>>> SearchAsyncWithHttpInfo (long? spaceId, EntityQuery query)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
