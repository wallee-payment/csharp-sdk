...
namespace Customweb.Wallee.Service
{
    ...
    public interface ILanguageService : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;RestLanguage&gt;</returns>
        System.Threading.Tasks.Task<List<RestLanguage>> AllAsync ();
        ...
        /// </remarks>
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;RestLanguage&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<RestLanguage>>> AllAsyncWithHttpInfo ();
    ...
    public partial class LanguageService : ILanguageService
    {
        ...
        /// <returns></returns>
        public LanguageService(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<RestLanguage> > AllWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<RestLanguage>>(localVarStatusCode,
                ...
                (List<RestLanguage>) ApiClient.Deserialize(localVarResponse, typeof(List<RestLanguage>)));
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;RestLanguage&gt;</returns>
        public async System.Threading.Tasks.Task<List<RestLanguage>> AllAsync ()
        {
             ApiResponse<List<RestLanguage>> localVarResponse = await AllAsyncWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;RestLanguage&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<RestLanguage>>> AllAsyncWithHttpInfo ()
        {
