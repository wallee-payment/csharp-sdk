...
namespace Customweb.Wallee.Service
{
    ...
    public interface ITokenService : IApiAccessor
    {
        ...
        /// <returns>TokenCreate</returns>
        TokenCreate Create (long? spaceId, TokenCreate entity);
        ...
        /// <param name="spaceId"></param>
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>ApiResponse of TokenCreate</returns>
        ApiResponse<TokenCreate> CreateWithHttpInfo (long? spaceId, TokenCreate entity);
        ...
        /// <param name="spaceId"></param>
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>Task of TokenCreate</returns>
        System.Threading.Tasks.Task<TokenCreate> CreateAsync (long? spaceId, TokenCreate entity);
        ...
        /// <param name="spaceId"></param>
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>Task of ApiResponse (TokenCreate)</returns>
        System.Threading.Tasks.Task<ApiResponse<TokenCreate>> CreateAsyncWithHttpInfo (long? spaceId, TokenCreate entity);
    ...
    public partial class TokenService : ITokenService
    {
        ...
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>TokenCreate</returns>
        public TokenCreate Create (long? spaceId, TokenCreate entity)
        {
             ApiResponse<TokenCreate> localVarResponse = CreateWithHttpInfo(spaceId, entity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>ApiResponse of TokenCreate</returns>
        public ApiResponse< TokenCreate > CreateWithHttpInfo (long? spaceId, TokenCreate entity)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
            ...
            return new ApiResponse<TokenCreate>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (TokenCreate) ApiClient.Deserialize(localVarResponse, typeof(TokenCreate)));
        }
        ...
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>Task of TokenCreate</returns>
        public async System.Threading.Tasks.Task<TokenCreate> CreateAsync (long? spaceId, TokenCreate entity)
        {
             ApiResponse<TokenCreate> localVarResponse = await CreateAsyncWithHttpInfo(spaceId, entity);
             return localVarResponse.Data;
        }
        ...
        /// <param name="entity">The token object with the properties which should be created.</param>
        /// <returns>Task of ApiResponse (TokenCreate)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TokenCreate>> CreateAsyncWithHttpInfo (long? spaceId, TokenCreate entity)
        {
            // verify the required parameter 'spaceId' is set
            if (spaceId == null)
            {
