...
namespace Customweb.Wallee.Service
{
    ...
    public interface IConditionTypeService : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;ConditionType&gt;</returns>
        System.Threading.Tasks.Task<List<ConditionType>> AllAsync ();
        ...
        /// </remarks>
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;ConditionType&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ConditionType>>> AllAsyncWithHttpInfo ();
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The id of the condition type which should be returned.</param>
        /// <returns>Task of ConditionType</returns>
        System.Threading.Tasks.Task<ConditionType> ReadAsync (long? id);
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The id of the condition type which should be returned.</param>
        /// <returns>Task of ApiResponse (ConditionType)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConditionType>> ReadAsyncWithHttpInfo (long? id);
    ...
    public partial class ConditionTypeService : IConditionTypeService
    {
        ...
        /// <returns></returns>
        public ConditionTypeService(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<ConditionType> > AllWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<ConditionType>>(localVarStatusCode,
                ...
                (List<ConditionType>) ApiClient.Deserialize(localVarResponse, typeof(List<ConditionType>)));
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;ConditionType&gt;</returns>
        public async System.Threading.Tasks.Task<List<ConditionType>> AllAsync ()
        {
             ApiResponse<List<ConditionType>> localVarResponse = await AllAsyncWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;ConditionType&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ConditionType>>> AllAsyncWithHttpInfo ()
        {
        ...
        public ApiResponse< ConditionType > ReadWithHttpInfo (long? id)
        {
            ...
            return new ApiResponse<ConditionType>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (ConditionType) ApiClient.Deserialize(localVarResponse, typeof(ConditionType)));
        }
        ...
        /// <param name="id">The id of the condition type which should be returned.</param>
        /// <returns>Task of ConditionType</returns>
        public async System.Threading.Tasks.Task<ConditionType> ReadAsync (long? id)
        {
             ApiResponse<ConditionType> localVarResponse = await ReadAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the condition type which should be returned.</param>
        /// <returns>Task of ApiResponse (ConditionType)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ConditionType>> ReadAsyncWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
