...
namespace Customweb.Wallee.Service
{
    ...
    public interface IPermissionService : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Permission>> AllAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Permission>>> AllAsyncWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<Permission> ReadAsync (long? id);
        ...
        System.Threading.Tasks.Task<ApiResponse<Permission>> ReadAsyncWithHttpInfo (long? id);
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        /// <returns></returns>
        public PermissionService(Configuration configuration = null)
        {
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;Permission&gt;</returns>
        public async System.Threading.Tasks.Task<List<Permission>> AllAsync ()
        {
             ApiResponse<List<Permission>> localVarResponse = await AllAsyncWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Customweb.Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;Permission&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Permission>>> AllAsyncWithHttpInfo ()
        {
        ...
        public ApiResponse< Permission > ReadWithHttpInfo (long? id)
        {
            ...
            return new ApiResponse<Permission>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (Permission) ApiClient.Deserialize(localVarResponse, typeof(Permission)));
        }
        ...
        /// <param name="id">The id of the permission which should be returned.</param>
        /// <returns>Task of Permission</returns>
        public async System.Threading.Tasks.Task<Permission> ReadAsync (long? id)
        {
             ApiResponse<Permission> localVarResponse = await ReadAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the permission which should be returned.</param>
        /// <returns>Task of ApiResponse (Permission)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Permission>> ReadAsyncWithHttpInfo (long? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
