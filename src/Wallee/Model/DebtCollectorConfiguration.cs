...
namespace Wallee.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DebtCollectorConfiguration")]
    public partial class DebtCollectorConfiguration : IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as SkipReviewEnabled should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeSkipReviewEnabled()
        {
            return false;
        }
        /// <summary>
        ...
        public List<DebtCollectorCondition> Conditions { get; private set; }
        ...
        public DebtCollector Collector { get; set; }
