...
namespace Wallee.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DebtCollectionCaseSource")]
    public partial class DebtCollectionCaseSource : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns false as ForcedPreparingState should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeForcedPreparingState()
        {
            return false;
        }
        /// <summary>
