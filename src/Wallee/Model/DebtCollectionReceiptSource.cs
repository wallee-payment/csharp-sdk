...
namespace Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebtCollectionReceiptSource :  IEquatable<DebtCollectionReceiptSource>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DebtCollectionReceiptSource);
        }

        /// <summary>
        /// Returns true if DebtCollectionReceiptSource instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtCollectionReceiptSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtCollectionReceiptSource input)
        {
            if (input == null)
                return false;
