...
namespace Wallee.Model
{
    ...
    /// PaymentAppConnector
    /// </summary>
    [DataContract(Name = "PaymentAppConnector")]
    public partial class PaymentAppConnector : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="completionConfiguration">completionConfiguration.</param>
        ...
        /// <summary>
        /// Returns false as PaymentPageEndpoint should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializePaymentPageEndpoint()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets CompletionConfiguration
        /// </summary>
        [DataMember(Name = "completionConfiguration", EmitDefaultValue = false)]
        public PaymentAppCompletionConfiguration CompletionConfiguration { get; set; }
        ...
        public PaymentAppProcessor Processor { get; set; }
        ...
        /// <summary>
        /// Returns false as AuthorizationTimeout should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAuthorizationTimeout()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets RefundConfiguration
        /// </summary>
        [DataMember(Name = "refundConfiguration", EmitDefaultValue = false)]
        public PaymentAppRefundConfiguration RefundConfiguration { get; set; }
