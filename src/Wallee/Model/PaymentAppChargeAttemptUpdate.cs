...
namespace Wallee.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentAppChargeAttemptUpdate")]
    public partial class PaymentAppChargeAttemptUpdate : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentAppChargeAttemptUpdate" /> class.
        /// </summary>
        /// <param name="reference">A unique identifier for the charge attempt within the systems of the external service provider. This field is mandatory when the target state is set to &#39;SUCCESSFUL&#39;..</param>
        ...
        /// </summary>
        /// <value>A unique identifier for the charge attempt within the systems of the external service provider. This field is mandatory when the target state is set to &#39;SUCCESSFUL&#39;.</value>
        ...
        /// </summary>
        /// <value>The reason for the charge attempt&#39;s failure. This field is mandatory when the target state is set to &#39;FAILED&#39;.</value>
        ...
        /// </summary>
        /// <value>A message explaining to the buyer why the payment failed. The message must be localized in the buyer&#39;s language, as specified in the payment page invocation URL.</value>
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // EndUserFailureMessage (string) maxLength
            if (this.EndUserFailureMessage != null && this.EndUserFailureMessage.Length > 2000)
            {
                yield return new ValidationResult("Invalid value for EndUserFailureMessage, length must be less than 2000.", new [] { "EndUserFailureMessage" });
            }
