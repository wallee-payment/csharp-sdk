...
namespace Wallee.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DebtCollectorCondition :  IEquatable<DebtCollectorCondition>
    {
        /// <summary>
        /// Gets or Sets State
        /// </summary>
        ...
        {
            return this.Equals(input as DebtCollectorCondition);
        }

        /// <summary>
        /// Returns true if DebtCollectorCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of DebtCollectorCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DebtCollectorCondition input)
        {
            if (input == null)
                return false;
