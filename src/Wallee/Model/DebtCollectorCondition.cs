...
namespace Wallee.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DebtCollectorCondition")]
    public partial class DebtCollectorCondition : IValidatableObject
    {
        ...
        public DebtCollectorCondition(CreationEntityState? state = default(CreationEntityState?), DebtCollectorConditionType type = default(DebtCollectorConditionType))
        {
            this.State = state;
            this.Type = type;
        }
        ...
        public DebtCollectorConditionType Type { get; set; }
