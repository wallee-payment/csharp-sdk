...
namespace Wallee.Service
{
    ...
    public partial class CurrencyBankAccountsService : ICurrencyBankAccountsService
    {
        ...
        /// <returns></returns>
        public CurrencyBankAccountsService(Wallee.Client.Configuration configuration)
        {
        ...
        public CurrencyBankAccountsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
