...
namespace Wallee.Service
{
    ...
    public partial class DeliveryIndicationsService : IDeliveryIndicationsService
    {
        ...
        /// <returns></returns>
        public DeliveryIndicationsService(Wallee.Client.Configuration configuration)
        {
        ...
        public DeliveryIndicationsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
