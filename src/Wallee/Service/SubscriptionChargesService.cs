...
namespace Wallee.Service
{
    ...
    public partial class SubscriptionChargesService : ISubscriptionChargesService
    {
        ...
        /// <returns></returns>
        public SubscriptionChargesService(Wallee.Client.Configuration configuration)
        {
        ...
        public SubscriptionChargesService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        public Wallee.Client.ApiResponse<SubscriptionCharge> PostSubscriptionsChargesWithHttpInfo(long space, SubscriptionChargeCreate subscriptionChargeCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'subscriptionChargeCreate' when calling SubscriptionChargesService->PostSubscriptionsCharges");
            }
