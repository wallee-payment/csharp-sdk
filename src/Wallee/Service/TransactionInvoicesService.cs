...
namespace Wallee.Service
{
    ...
    public partial class TransactionInvoicesService : ITransactionInvoicesService
    {
        ...
        /// <returns></returns>
        public TransactionInvoicesService(Wallee.Client.Configuration configuration)
        {
        ...
        public TransactionInvoicesService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Wallee.Client.ApiResponse<bool> localVarResponse = GetPaymentTransactionsInvoicesIdCheckReplacementPossibleWithHttpInfo(id, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of bool</returns>
        public Wallee.Client.ApiResponse<bool> GetPaymentTransactionsInvoicesIdCheckReplacementPossibleWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
        ...
        {
            Wallee.Client.ApiResponse<RenderedDocument> localVarResponse = GetPaymentTransactionsInvoicesIdDocumentWithHttpInfo(id, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RenderedDocument</returns>
        public Wallee.Client.ApiResponse<RenderedDocument> GetPaymentTransactionsInvoicesIdDocumentWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
        ...
        public Wallee.Client.ApiResponse<TransactionInvoice> PostPaymentTransactionsInvoicesIdReplaceWithHttpInfo(long id, long space, TransactionInvoiceReplacement transactionInvoiceReplacement, List<string>? expand = default, int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'transactionInvoiceReplacement' when calling TransactionInvoicesService->PostPaymentTransactionsInvoicesIdReplace");
            }
