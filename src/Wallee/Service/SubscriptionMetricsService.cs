...
namespace Wallee.Service
{
    ...
    public partial class SubscriptionMetricsService : ISubscriptionMetricsService
    {
        ...
        /// <returns></returns>
        public SubscriptionMetricsService(Wallee.Client.Configuration configuration)
        {
        ...
        public SubscriptionMetricsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> DeleteSubscriptionsMetricsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        public Wallee.Client.ApiResponse<SubscriptionMetric> PatchSubscriptionsMetricsIdWithHttpInfo(long id, long space, SubscriptionMetricActive subscriptionMetricActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'subscriptionMetricActive' when calling SubscriptionMetricsService->PatchSubscriptionsMetricsId");
            }
        ...
        public Wallee.Client.ApiResponse<SubscriptionMetric> PostSubscriptionsMetricsWithHttpInfo(long space, SubscriptionMetricCreate subscriptionMetricCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'subscriptionMetricCreate' when calling SubscriptionMetricsService->PostSubscriptionsMetrics");
            }
