...
namespace Wallee.Service
{
    ...
    public partial class SubscriptionProductsService : ISubscriptionProductsService
    {
        ...
        /// <returns></returns>
        public SubscriptionProductsService(Wallee.Client.Configuration configuration)
        {
        ...
        public SubscriptionProductsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        public Wallee.Client.ApiResponse<SubscriptionProduct> PatchSubscriptionsProductsIdWithHttpInfo(long id, long space, SubscriptionProductActive subscriptionProductActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'subscriptionProductActive' when calling SubscriptionProductsService->PatchSubscriptionsProductsId");
            }
        ...
        public Wallee.Client.ApiResponse<SubscriptionProduct> PostSubscriptionsProductsWithHttpInfo(long space, SubscriptionProductCreate subscriptionProductCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'subscriptionProductCreate' when calling SubscriptionProductsService->PostSubscriptionsProducts");
            }
        ...
        public Wallee.Client.ApiResponse<SubscriptionProductRetirement> PostSubscriptionsProductsIdRetireWithHttpInfo(long id, long space, SubscriptionProductRetirementRequest subscriptionProductRetirementRequest, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'subscriptionProductRetirementRequest' when calling SubscriptionProductsService->PostSubscriptionsProductsIdRetire");
            }
