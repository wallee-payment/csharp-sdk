...
namespace Wallee.Service
{
    ...
    public partial class TransactionCommentsService : ITransactionCommentsService
    {
        ...
        /// <returns></returns>
        public TransactionCommentsService(Wallee.Client.Configuration configuration)
        {
        ...
        public TransactionCommentsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> DeletePaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("transactionId", Wallee.Client.ClientUtils.ParameterToString(transactionId)); // path parameter
        ...
        public Wallee.Client.ApiResponse<TransactionComment> PatchPaymentTransactionsTransactionIdCommentsIdWithHttpInfo(long transactionId, long id, long space, TransactionCommentActive transactionCommentActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'transactionCommentActive' when calling TransactionCommentsService->PatchPaymentTransactionsTransactionIdCommentsId");
            }
        ...
        public Wallee.Client.ApiResponse<TransactionComment> PostPaymentTransactionsTransactionIdCommentsWithHttpInfo(long transactionId, long space, TransactionCommentCreate transactionCommentCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'transactionCommentCreate' when calling TransactionCommentsService->PostPaymentTransactionsTransactionIdComments");
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> PostPaymentTransactionsTransactionIdCommentsIdPinWithHttpInfo(long transactionId, long id, long space, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> PostPaymentTransactionsTransactionIdCommentsIdUnpinWithHttpInfo(long transactionId, long id, long space, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
