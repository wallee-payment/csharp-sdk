...
namespace Wallee.Service
{
    ...
    public partial class RefundsService : IRefundsService
    {
        ...
        /// <returns></returns>
        public RefundsService(Wallee.Client.Configuration configuration)
        {
        ...
        public RefundsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Wallee.Client.ApiResponse<RenderedDocument> localVarResponse = GetPaymentRefundsIdDocumentWithHttpInfo(id, space);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RenderedDocument</returns>
        public Wallee.Client.ApiResponse<RenderedDocument> GetPaymentRefundsIdDocumentWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
        ...
        public Wallee.Client.ApiResponse<Refund> PostPaymentRefundsWithHttpInfo(long space, RefundCreate refundCreate, List<string>? expand = default, int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'refundCreate' when calling RefundsService->PostPaymentRefunds");
            }
