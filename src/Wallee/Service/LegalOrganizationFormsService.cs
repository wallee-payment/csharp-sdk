...
namespace Wallee.Service
{
    ...
    public partial class LegalOrganizationFormsService : ILegalOrganizationFormsService
    {
        ...
        /// <returns></returns>
        public LegalOrganizationFormsService(Wallee.Client.Configuration configuration)
        {
        ...
        public LegalOrganizationFormsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
