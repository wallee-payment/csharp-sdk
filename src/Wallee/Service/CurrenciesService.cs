...
namespace Wallee.Service
{
    ...
    public partial class CurrenciesService : ICurrenciesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyListResponse</returns>
        public Wallee.Client.ApiResponse<CurrencyListResponse> GetCurrenciesWithHttpInfo(List<string>? expand = default, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencySearchResponse</returns>
        public Wallee.Client.ApiResponse<CurrencySearchResponse> GetCurrenciesSearchWithHttpInfo(List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
