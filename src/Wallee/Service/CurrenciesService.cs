...
namespace Wallee.Service
{
    ...
    public partial class CurrenciesService : ICurrenciesService
    {
        ...
        /// <returns></returns>
        public CurrenciesService(Wallee.Client.Configuration configuration)
        {
        ...
        public CurrenciesService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Wallee.Client.ApiResponse<CurrencyListResponse> localVarResponse = GetCurrenciesWithHttpInfo(expand);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencyListResponse</returns>
        public Wallee.Client.ApiResponse<CurrencyListResponse> GetCurrenciesWithHttpInfo(List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
        ...
        {
            Wallee.Client.ApiResponse<RestCurrency> localVarResponse = GetCurrenciesCodeWithHttpInfo(code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RestCurrency</returns>
        public Wallee.Client.ApiResponse<RestCurrency> GetCurrenciesCodeWithHttpInfo(string code, int operationIndex = 0)
        {
            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'code' when calling CurrenciesService->GetCurrenciesCode");
            }
        ...
        {
            Wallee.Client.ApiResponse<CurrencySearchResponse> localVarResponse = GetCurrenciesSearchWithHttpInfo(expand, limit, offset, order, query);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrencySearchResponse</returns>
        public Wallee.Client.ApiResponse<CurrencySearchResponse> GetCurrenciesSearchWithHttpInfo(List<string>? expand = default(List<string>?), int? limit = default(int?), int? offset = default(int?), string? order = default(string?), string? query = default(string?), int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
