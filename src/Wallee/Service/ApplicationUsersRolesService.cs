...
namespace Wallee.Service
{
    ...
    public partial class ApplicationUsersRolesService : IApplicationUsersRolesService
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAccountRole</returns>
        public Wallee.Client.ApiResponse<UserAccountRole> PostApplicationUsersUserIdAccountRolesWithHttpInfo(long userId, long roleId, long account, bool? appliesOnSubAccount = default, int operationIndex = 0)
        {
            Wallee.Client.RequestOptions localVarRequestOptions = new Wallee.Client.RequestOptions();
