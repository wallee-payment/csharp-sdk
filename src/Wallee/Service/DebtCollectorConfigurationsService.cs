...
namespace Wallee.Service
{
    ...
    /// </summary>
    public interface IDebtCollectorConfigurationsServiceSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteDebtCollectionConfigurationsId(long id, long space, int operationIndex = 0);
        ...
        /// <param name="id"></param>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="debtCollectorConfigurationUpdate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DebtCollectorConfiguration</returns>
        ...
        /// <exception cref="Wallee.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="space">Specifies the ID of the space the operation should be executed in.</param>
        /// <param name="debtCollectorConfigurationCreate"></param>
        /// <param name="expand"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DebtCollectorConfiguration</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDebtCollectorConfigurationsService : IDebtCollectorConfigurationsServiceSync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DebtCollectorConfigurationsService : IDebtCollectorConfigurationsService
    {

        private Wallee.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DebtCollectorConfigurationsService"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public DebtCollectorConfigurationsService(Wallee.Client.Configuration configuration)
        {
        ...
        public DebtCollectorConfigurationsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteDebtCollectionConfigurationsId(long id, long space, int operationIndex = 0)
        {
            DeleteDebtCollectionConfigurationsIdWithHttpInfo(id, space);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> DeleteDebtCollectionConfigurationsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DebtCollectorConfigurationsService.DeleteDebtCollectionConfigurationsId";
            ...
            {
                Exception _exception = this.ExceptionFactory("DeleteDebtCollectionConfigurationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Wallee.Client.ApiResponse<DebtCollectorConfigurationListResponse> GetDebtCollectionConfigurationsWithHttpInfo(long space, long? after = default, long? before = default, List<string>? expand = default, int? limit = default, SortingOrder? order = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DebtCollectorConfigurationsService.GetDebtCollectionConfigurations";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetDebtCollectionConfigurations", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Wallee.Client.ApiResponse<DebtCollectorConfiguration> GetDebtCollectionConfigurationsIdWithHttpInfo(long id, long space, List<string>? expand = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DebtCollectorConfigurationsService.GetDebtCollectionConfigurationsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetDebtCollectionConfigurationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Wallee.Client.ApiResponse<DebtCollectorConfigurationSearchResponse> GetDebtCollectionConfigurationsSearchWithHttpInfo(long space, List<string>? expand = default, int? limit = default, int? offset = default, string? order = default, string? query = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DebtCollectorConfigurationsService.GetDebtCollectionConfigurationsSearch";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetDebtCollectionConfigurationsSearch", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Wallee.Client.ApiResponse<DebtCollectorConfiguration> PatchDebtCollectionConfigurationsIdWithHttpInfo(long id, long space, DebtCollectorConfigurationUpdate debtCollectorConfigurationUpdate, List<string>? expand = default, int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'debtCollectorConfigurationUpdate' when calling DebtCollectorConfigurationsService->PatchDebtCollectionConfigurationsId");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", Wallee.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = debtCollectorConfigurationUpdate;

            localVarRequestOptions.Operation = "DebtCollectorConfigurationsService.PatchDebtCollectionConfigurationsId";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchDebtCollectionConfigurationsId", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public Wallee.Client.ApiResponse<DebtCollectorConfiguration> PostDebtCollectionConfigurationsWithHttpInfo(long space, DebtCollectorConfigurationCreate debtCollectorConfigurationCreate, List<string>? expand = default, int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'debtCollectorConfigurationCreate' when calling DebtCollectorConfigurationsService->PostDebtCollectionConfigurations");
            }
            ...
            localVarRequestOptions.HeaderParameters.Add("Space", Wallee.Client.ClientUtils.ParameterToString(space)); // header parameter
            localVarRequestOptions.Data = debtCollectorConfigurationCreate;

            localVarRequestOptions.Operation = "DebtCollectorConfigurationsService.PostDebtCollectionConfigurations";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostDebtCollectionConfigurations", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
