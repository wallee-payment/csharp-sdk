...
namespace Wallee.Service
{
    ...
    public partial class PaymentProcessorConfigurationsService : IPaymentProcessorConfigurationsService
    {
        ...
        /// <returns></returns>
        public PaymentProcessorConfigurationsService(Wallee.Client.Configuration configuration)
        {
        ...
        public PaymentProcessorConfigurationsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> DeletePaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        public Wallee.Client.ApiResponse<PaymentProcessorConfiguration> PatchPaymentProcessorConfigurationsIdWithHttpInfo(long id, long space, PaymentProcessorConfigurationActive paymentProcessorConfigurationActive, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'paymentProcessorConfigurationActive' when calling PaymentProcessorConfigurationsService->PatchPaymentProcessorConfigurationsId");
            }
        ...
        public Wallee.Client.ApiResponse<PaymentProcessorConfiguration> PostPaymentProcessorConfigurationsWithHttpInfo(long space, PaymentProcessorConfigurationCreate paymentProcessorConfigurationCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'paymentProcessorConfigurationCreate' when calling PaymentProcessorConfigurationsService->PostPaymentProcessorConfigurations");
            }
