...
namespace Wallee.Service
{
    ...
    public partial class SubscriptionPeriodBillsService : ISubscriptionPeriodBillsService
    {
        ...
        /// <returns></returns>
        public SubscriptionPeriodBillsService(Wallee.Client.Configuration configuration)
        {
        ...
        public SubscriptionPeriodBillsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        public Wallee.Client.ApiResponse<SubscriptionPeriodBill> PostSubscriptionsPeriodBillsIdCloseWithHttpInfo(long id, DateTime currentDate, bool createNextPeriod, long space, List<string>? expand = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.PathParameters.Add("id", Wallee.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.QueryParameters.Add(Wallee.Client.ClientUtils.ParameterToMultiMap("", "currentDate", currentDate));
            localVarRequestOptions.QueryParameters.Add(Wallee.Client.ClientUtils.ParameterToMultiMap("", "createNextPeriod", createNextPeriod));
            if (expand != null)
            {
                localVarRequestOptions.QueryParameters.Add(Wallee.Client.ClientUtils.ParameterToMultiMap("multi", "expand", expand));
            }
