...
namespace Wallee.Service
{
    ...
    public partial class TransactionLineItemVersionsService : ITransactionLineItemVersionsService
    {
        ...
        /// <returns></returns>
        public TransactionLineItemVersionsService(Wallee.Client.Configuration configuration)
        {
        ...
        public TransactionLineItemVersionsService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        public Wallee.Client.ApiResponse<TransactionLineItemVersion> PostPaymentTransactionsLineItemVersionsWithHttpInfo(long space, TransactionLineItemVersionCreate transactionLineItemVersionCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'transactionLineItemVersionCreate' when calling TransactionLineItemVersionsService->PostPaymentTransactionsLineItemVersions");
            }
