...
namespace Wallee.Service
{
    ...
    public partial class TokensService : ITokensService
    {
        ...
        /// <returns></returns>
        public TokensService(Wallee.Client.Configuration configuration)
        {
        ...
        public TokensService(Wallee.Client.ISynchronousClient client, Wallee.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Wallee.Client.ApiResponse<Object> DeletePaymentTokensIdWithHttpInfo(long id, long space, int operationIndex = 0)
        {
        ...
        public Wallee.Client.ApiResponse<Token> PatchPaymentTokensIdWithHttpInfo(long id, long space, TokenUpdate tokenUpdate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            if (tokenUpdate == null)
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'tokenUpdate' when calling TokensService->PatchPaymentTokensId");
            }
        ...
        public Wallee.Client.ApiResponse<Token> PostPaymentTokensWithHttpInfo(long space, TokenCreate tokenCreate, List<string>? expand = default(List<string>?), int operationIndex = 0)
        {
            ...
            if (tokenCreate == null)
            {
                throw new Wallee.Client.ApiException(400, "Missing required parameter 'tokenCreate' when calling TokensService->PostPaymentTokens");
            }
