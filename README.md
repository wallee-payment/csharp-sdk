...
```
# Package Manager
Install-Package Wallee -Version 9.1.0
# .NET CLI
dotnet add package Wallee --version 9.1.0
# Paket CLI
paket add Wallee --version 9.1.0
# PackageReference
<PackageReference Include="Wallee" Version="9.1.0" />
```
