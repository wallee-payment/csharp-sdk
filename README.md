...
```
# Package Manager
Install-Package Wallee -Version 2.0.6
# .NET CLI
dotnet add package Wallee --version 2.0.6
# Paket CLI
paket add Wallee --version 2.0.6
# PackageReference
<PackageReference Include="Wallee" Version="2.0.6" />
```
