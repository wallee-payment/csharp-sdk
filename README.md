...
```
# Package Manager
Install-Package Wallee -Version 2.2.0
# .NET CLI
dotnet add package Wallee --version 2.2.0
# Paket CLI
paket add Wallee --version 2.2.0
# PackageReference
<PackageReference Include="Wallee" Version="2.2.0" />
```
