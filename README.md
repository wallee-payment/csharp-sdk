...
```
# Package Manager
Install-Package Wallee -Version 2.2.1
# .NET CLI
dotnet add package Wallee --version 2.2.1
# Paket CLI
paket add Wallee --version 2.2.1
# PackageReference
<PackageReference Include="Wallee" Version="2.2.1" />
```
