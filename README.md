...
```
# Package Manager
Install-Package Wallee -Version 4.0.4
# .NET CLI
dotnet add package Wallee --version 4.0.4
# Paket CLI
paket add Wallee --version 4.0.4
# PackageReference
<PackageReference Include="Wallee" Version="4.0.4" />
```
